...
public class EquipmentRepairView extends StandardView {
    ...
    @ViewComponent
    private CollectionContainer<RepairOrder> repairOrdersDc;
    @Autowired
...
//                    .open());
            ...
            completeButton.addClickListener(e ->
                    viewNavigators.detailView(this, RepairOrder.class)
                            .withViewClass(RepairOrderConfirmView.class)
                            .editEntity(repairOrder)
                            .withBackwardNavigation(true)
                            .navigate());
//            completeButton.addClickListener(e -> dialogWindows.detail(this, RepairOrder.class)
//                    .withViewClass(RepairOrderConfirmView.class)
//                    .editEntity(repairOrder)
//                    .withAfterCloseListener(closeEvent -> {
//                        if (closeEvent.closedWith(StandardOutcome.SAVE)) {
...
//                    .open());
            ...
            buttonsPanel.add(startButton, completeButton);
